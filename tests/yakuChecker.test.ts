...
function makeYaku(hais: number[], melds: Meld[] = []): YakuChecker {
...
describe("字一色", () => {
    test("tsuiso_1", () => {
        const yaku = makeYaku([28,28,29,29,29,31,31,31,32,32,32,34,34,34]);
    ...
    test("tsuiso_2", () => {
        ...
        const yaku = makeYaku([28,28,29,29,29,31,31,31], [...melds])
...
describe("清老頭", () => {
    test("chinroto_1", () => {
        const yaku = makeYaku([1,1,1,9,9,9,10,10,18,18,18,27,27,27]);
    ...
    test("chinroto_2", () => {
        ...
        const yaku = makeYaku([9,9,9,10,10,18,18,18], [...melds])
...
describe("緑一色", () => {
    ...
    test("ryuiso_2", () => {
        ...
        const yaku = makeYaku([20,21,22,24,24,24,26,26], [...melds])
...
describe("大四喜", () => {
    test("daisushi_1", () => {
        const yaku = makeYaku([1,1,28,28,28,29,29,29,30,30,30,31,31,31]);
    ...
    test("daisushi_2", () => {
        const yaku = makeYaku([28,28,28,29,29,29,30,30,30,31,31,31,33,33]);

        const expected = new Map<number, Map<string, number>>();
        expected.set(0, new Map<string, number>([["字一色", 0],["大四喜", 0]]));
        expect(yaku.check()).toEqual(expected);
    });
    test("daisushi_2", () => {
        const melds = new Melds();
        ...
        const yaku = makeYaku([26,26,28,28,28,30,30,30,], [...melds])
...
describe("小四喜", () => {
    test("shosushi_1", () => {
        const yaku = makeYaku([1,1,1,28,28,28,29,29,30,30,30,31,31,31]);
    ...
    test("shosushi_2", () => {
        const yaku = makeYaku([28,28,28,29,29,29,30,30,31,31,31,33,33,33]);

        const expected = new Map<number, Map<string, number>>();
        expected.set(0, new Map<string, number>([["字一色", 0],["小四喜", 0]]));
        expect(yaku.check()).toEqual(expected);
    });
    test("shosushi_3", () => {
        const melds = new Melds();
        ...
        const yaku = makeYaku([25,26,27,28,28,30,30,30], [...melds])
